...
export default function LandingPage () {
  return (
      ...
      <div className="mx-auto flex min-h-screen w-screen flex-col px-4 sm:px-3 lg:px-3">
        {/* Simple Nav */}
        <header className="flex h-14 items-center justify-between border-b shadow-sm">
        ...
        {/* Footer */}
        <footer className="h-12 border-t flex items-center justify-between px-4 text-xs text-slate-500 dark:text-slate-400">
